            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-5">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem id dolore eum nulla ipsam sint aspernatur necessitatibus accusantium velit fugiat saepe quas non vel, eius provident tempora fugit dolor error.
                    </div>
